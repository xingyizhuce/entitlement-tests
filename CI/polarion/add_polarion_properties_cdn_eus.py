...
def get_testrun_name():
    ...
    RHEL Product:     RHELEntitlement-RHEL<master_release><minor_release>-<test_type><compose_version>-<variant>_<arch>_<cdn>-CDN
    RHEL-ALT Product: RHELEntitlement-RHEL-ALT-<master_release><minor_release>-<test_type><compose_version>-<variant>_<arch>_<cdn>-CDN
    HTB Product:      RHELEntitlement-RHEL<master_release><minor_release>-<test_type><compose_version>-HTB-<variant>_<arch>_<cdn>-CDN
    EUS Product:      RHELEntitlement-RHEL<master_release><minor_release>-<variant>_<arch>_<cdn>-CDN
    Add-on Product:   <product_type>Entitlement-RHEL<master_release><minor_release>-<variant>_<arch>_<cdn>-CDN
    ...
    if product_type in ["RHEL7", "RHEL8"]:
        testrun_name = "RHELEntitlement-RHEL{0}{1}-{2}{3}-{4}_{5}_{6}-CDN".format(master_release, minor_release, test_type, compose_version, variant, arch, cdn)
    elif product_type == "HTB_Beta":
        testrun_name = "RHELEntitlement-RHEL{0}{1}-Beta{2}-HTB-{3}_{4}_{5}-CDN".format(master_release, minor_release, compose_version, variant, arch, cdn)
    elif product_type == "HTB_Snapshot":
        testrun_name = "RHELEntitlement-RHEL{0}{1}-Snapshot{2}-HTB-{3}_{4}_{5}-CDN".format(master_release, minor_release, compose_version, variant, arch, cdn)
    elif product_type == "RHEL-ALT":
        testrun_name = "RHELEntitlement-RHEL-ALT-{0}{1}-{2}{3}-{4}_{5}_{6}-CDN".format(master_release, minor_release, test_type, compose_version, variant, arch, cdn)
    elif product_type == "EUS":
        testrun_name = "RHELEntitlement-RHEL{0}{1}-EUS-{2}_{3}_{4}-CDN".format(master_release, minor_release, variant, arch, cdn)
    else:
        testrun_name = "{0}Entitlement-RHEL{1}{2}-{3}_{4}_{5}-CDN".format(product_type, master_release, minor_release, variant, arch, cdn)
    return testrun_name
